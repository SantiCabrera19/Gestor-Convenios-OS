    ...
    try {
      ...
      const { data, error } = await supabase.auth.signInWithOAuth({
        ...
        options: {
          ...
          scopes: 'https://www.googleapis.com/auth/drive', // Scope completo para gestionar archivos y carpetas
          queryParams: {
            access_type: 'offline', // Necesario para obtener refresh_token
            prompt: 'consent', // Fuerza a Google a enviar el refresh_token siempre
          },
        },
      });
